    ...
    override fun onCreateView(
        ...
        viewModel.userData.observe(viewLifecycleOwner) {
            when (it[0]) {
                ...
                "passwordFailed" -> {
                    Snackbar.make(binding.tvLogin, "La contraseña es incorrecta", Snackbar.LENGTH_SHORT).show()
                }

                "accountFailed" -> {
                    Snackbar.make(binding.tvLogin, "El nombre de usuario o el correo electrónico son incorrectos", Snackbar.LENGTH_SHORT).show()
                }
