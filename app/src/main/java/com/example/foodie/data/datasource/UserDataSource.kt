...
class UserDataSource(var collectionUser: CollectionReference, var loginPref: LoginPref) {
    ...
    suspend fun loadAccountCard(): List<AccountCardItem> =
        withContext(Dispatchers.IO) {
            ...
            val a1 = AccountCardItem("vc_email", "Cambio de Correo Electrónico")
            val a2 = AccountCardItem("vc_password", "Cambio de Contraseña")
            val a3 = AccountCardItem("vc_logout", "Cerrar sesión")
